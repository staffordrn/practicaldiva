        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    ?>
                    <form action="/practicaldiva/admin/index.php" id="delete_review" method="post">
                        
                        <h2>You are about to delete the review by <?php echo $review_data['review_name'] ?></h2>
                        <h2 class="warning">Do you really want to delete your review? The delete is permanent</h2>
